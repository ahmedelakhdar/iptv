        ...
        <header className="glass-pill flex items-center justify-between w-full rounded-full px-4 py-2.5 sm:px-6 sm:py-3 transition-all duration-300 relative z-50 shadow-xl">
          ...
          <div className="hidden items-center gap-3 md:flex">
            ...
            <div className="relative">
              ...
              {langDropdownOpen && (
                <div className="absolute right-0 mt-2 w-36 rounded-2xl border border-black/10 dark:border-white/15 bg-white/95 dark:bg-[#070714]/95 p-1.5 shadow-2xl backdrop-blur-2xl z-50">
                  {languages.map((lang) => (
                    <button
                      key={lang.code}
                      onClick={() => {
          ...
          {/* Right: Mobile Controls Side-By-Side (Language, Theme, Hamburger) */}
          <div className="flex items-center gap-1.5 sm:gap-2 md:hidden relative z-50 pointer-events-auto">
            ...
            <div className="relative">
              ...
              {langDropdownOpen && (
                <div className="absolute right-0 mt-2 w-36 rounded-2xl border border-slate-700/50 dark:border-white/15 bg-slate-900/95 dark:bg-[#070714]/95 p-1.5 shadow-2xl backdrop-blur-2xl z-50">
                  {languages.map((lang) => (
                    <button
                      key={lang.code}
                      onClick={() => {
            ...
            <button
              onClick={() => mounted && setTheme(theme === "dark" ? "light" : "dark")}
              aria-label="Toggle Theme"
              className="flex h-9 w-9 items-center justify-center rounded-xl border border-slate-300/80 dark:border-white/15 bg-slate-900/80 dark:bg-black/60 text-slate-100 backdrop-blur-md shadow-sm transition-all active:scale-95 min-h-[36px] min-w-[36px]"
            >
              {mounted ? (
                theme === "dark" ? (
                  <Sun className="h-4 w-4 text-amber-400" />
