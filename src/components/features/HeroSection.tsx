...
export function HeroSection() {
  ...
  return (
    <section id="accueil" className="relative min-h-[100dvh] pt-28 sm:pt-36 pb-16 overflow-hidden flex flex-col justify-center w-full max-w-full">
      
      {/* Animated Ambient Glowing Orbs - Accelerated WebKit GPU Compositing Layers */}
      <div className="pointer-events-none z-0 absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[350px] w-[350px] sm:h-[600px] sm:w-[600px] rounded-full bg-gradient-to-r from-violet-600/20 via-fuchsia-600/15 to-cyan-500/20 blur-2xl sm:blur-3xl animate-ambient-orb-1 transform-gpu" />
      <div className="pointer-events-none z-0 absolute top-1/3 left-1/3 h-[300px] w-[300px] sm:h-[450px] sm:w-[450px] rounded-full bg-gradient-to-r from-cyan-500/15 via-blue-600/15 to-purple-600/20 blur-2xl sm:blur-3xl animate-ambient-orb-2 transform-gpu" />

      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 text-center relative z-10 w-full max-w-full">
        
        {/* Top Floating Badge */}
        <div className="inline-flex items-center gap-2 rounded-full border border-violet-500/30 bg-violet-950/30 dark:bg-violet-950/50 px-3.5 sm:px-4 py-1.5 backdrop-blur-md mb-6 sm:mb-8 shadow-sm max-w-full transform-gpu">
        ...
        <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5 relative z-50 pointer-events-auto w-full max-w-full">
          ...
          <Link
            href="/tarifs"
            className="group relative z-50 w-full sm:w-auto inline-flex items-center justify-center gap-3 overflow-hidden rounded-full violet-cyan-gradient px-6 sm:px-8 py-3.5 text-sm sm:text-base font-bold text-white shadow-lg transition-all duration-300 hover:scale-105 min-h-[48px] pointer-events-auto max-w-full text-center transform-gpu"
          >
        ...
        <div className="mt-10 sm:mt-14 relative max-w-4xl mx-auto z-10 w-full max-w-full overflow-hidden transform-gpu">
          {/* Glowing Backlight Frame */}
          <div className="pointer-events-none z-0 absolute inset-0 rounded-3xl bg-gradient-to-r from-violet-600/30 via-fuchsia-600/20 to-cyan-500/30 blur-2xl opacity-70 animate-pulse transform-gpu" />

          {/* Outer Frame Container */}
          <div className="relative z-10 glass-bento rounded-3xl p-1.5 sm:p-3 border border-slate-200 dark:border-white/15 shadow-xl overflow-hidden bg-black/40 w-full max-w-full transform-gpu">
            <IptvPlayerMockup />
          </div>
        </div>
