...
export function HeroSection() {
  ...
  return (
    <section id="accueil" className="relative min-h-[100dvh] pt-28 sm:pt-36 pb-16 overflow-hidden flex flex-col justify-center w-full max-w-full">
      ...
      {/* Animated Ambient Glowing Orbs - Strictly Desktop Only (hidden md:block) to prevent mobile iOS VRAM exhaustion */}
      <div className="hidden md:block pointer-events-none z-0 absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[600px] w-[600px] rounded-full bg-gradient-to-r from-violet-600/20 via-fuchsia-600/15 to-cyan-500/20 blur-3xl animate-ambient-orb-1" />
      <div className="hidden md:block pointer-events-none z-0 absolute top-1/3 left-1/3 h-[450px] w-[450px] rounded-full bg-gradient-to-r from-cyan-500/15 via-blue-600/15 to-purple-600/20 blur-3xl animate-ambient-orb-2" />
